...
const About: React.FC = () => {
  return (
    <div className="bg-white dark:bg-gray-900 py-12 px-4 sm:px-6 lg:py-16 lg:px-8 mx-auto max-w-3xl">
      <h1 className="text-center text-3xl font-bold leading-9 text-gray-900 dark:text-white">
        About Us
      </h1>
      <div className="mt-6 space-y-6 text-gray-700 dark:text-gray-300">
        ...
        <p>
          ...
          founders were brought together by a shared passion for harnessing the
          power of artificial intelligence to drive positive change.
        </p>
        <p>
          The initial idea for ARTEMIS took root when we triumphed as 1st place
          winners at the prestigious Waterloo Generative AI Hackathon. Competing
          against the brightest minds in the Waterloo undergraduate and graduate
          student community, we not only emerged victorious but also recognized
          the transformative potential of our concept.
        </p>
        <p>
        ...
        <p>
          ...
          ecosystem that fosters innovation and nurtures emerging startups. This
          invaluable support has propelled ARTEMIS to new heights, enabling us
          to refine our technology and bring it to the forefront of healthcare
          research.
        </p>
        <p>
          ...
          speeding up healthcare research, improving accuracy, and democratizing
          access to knowledge. Our journey is just beginning, and we are excited
          to shape the future of healthcare research, one systematic review at a
          time.
        </p>
      </div>
    </div>
